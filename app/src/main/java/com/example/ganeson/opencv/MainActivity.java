...
public class MainActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startActivity(new Intent(this,SafeNavigateActivity.class));
        javaCameraView = (JavaCameraView) findViewById(R.id.idForJavaCameraView);
        ...
        //faceDetector = new CascadeClassifier(getResources().getString(R.raw.haarcascade_frontalface_alt));
    }
